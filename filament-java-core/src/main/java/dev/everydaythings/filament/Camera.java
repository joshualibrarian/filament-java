...
public class Camera {
     ...
     * @see Projection
     */
    public void setProjection(Projection projection, double left, double right,
     ...
     *                              for {@link Projection#ORTHO}.
     */
    public void setCustomProjection(double[] inProjection,
     ...
     */
    @Deprecated
    public void setScaling(double[] inScaling) {
    ...
    public double[] getShift(double[] out) {
     ...
     */
    public double getFieldOfViewInDegrees(Fov direction) {
    ...
    public double[] getProjectionMatrix(double[] out) {
    ...
    public double[] getCullingProjectionMatrix(double[] out) {
        out = Asserts.assertMat4d(out);
    ...
    public double[] getScaling(double[] out) {
    ...
    public float[] getModelMatrix(float[] out) {
    ...
    public double[] getModelMatrix(double[] out) {
    ...
    public double[] getViewMatrix(double[] out) {
        out = Asserts.assertMat4(out);
    ...
    public float[] getLeftVector(float[] out) {
        out = Asserts.assertFloat3(out);
    ...
    public float[] getUpVector(float[] out) {
        out = Asserts.assertFloat3(out);
    ...
    public float[] getForwardVector(float[] out) {
        out = Asserts.assertFloat3(out);
     ...
     */
    public void setEyeModelMatrix(int eyeId, double[] model) {

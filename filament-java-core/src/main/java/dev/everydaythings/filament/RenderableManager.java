...
public class RenderableManager {
    ...
    public static class Builder {
        ...
        public Builder geometry(int index, PrimitiveType type,
        ...
        public Builder material(int index, MaterialInstance material) {
        ...
        public Builder blendOrder(int index,
                int blendOrder) {
       ...
       /**
        ...
        public Builder globalBlendOrderEnabled(int index, boolean enabled) {
        ...
        public Builder boundingBox(Box aabb) {
        ...
        public Builder layerMask(int select,
                int value) {
        ...
        public Builder lightChannel(int channel, boolean enable) {
        ...
        public Builder skinning(int boneCount) {
        ...
        public Builder skinning(int boneCount, Buffer bones) {
        ...
        public Builder morphing(int targetCount) {
        ...
        public Builder morphing(int level,
                                int primitiveIndex,
                                int offset) {
         ...
         */
        public void build(Engine engine, @Entity int entity) {
     ...
     * @param offset Offset in the {@link SkinningBuffer}
     */
    public void setSkinningBuffer(@EntityInstance int i, SkinningBuffer skinningBuffer,
    ...
    public void setBonesAsQuaternions(@EntityInstance int i,
            Buffer quaternions, int boneCount,
            int offset) {
     ...
     */
    public void setMorphWeights(@EntityInstance int i, float[] weights, int offset) {
     ...
     */
    public void setAxisAlignedBoundingBox(@EntityInstance int i, Box aabb) {
     ...
     */
    public void setLayerMask(@EntityInstance int i, int select,
            int value) {
     ...
     * @see Builder#priority
     */
    public void setPriority(@EntityInstance int i, int priority) {
     ...
     * @see Builder#channel
     */
    public void setChannel(@EntityInstance int i, int channel) {
     ...
     */
    public void setLightChannel(@EntityInstance int i, int channel, boolean enable) {
     ...
     */
    public boolean getLightChannel(@EntityInstance int i, int channel) {
    ...
    public Box getAxisAlignedBoundingBox(@EntityInstance int i, Box out) {
     ...
     */
    public void setMaterialInstanceAt(@EntityInstance int i, int primitiveIndex,
     ...
     */
    public void clearMaterialInstanceAt(@EntityInstance int i, int primitiveIndex) {
     ...
     */
    public MaterialInstance getMaterialInstanceAt(@EntityInstance int i,
            int primitiveIndex) {
     ...
     */
    public void setGeometryAt(@EntityInstance int i, int primitiveIndex,
            PrimitiveType type, VertexBuffer vertices,
            IndexBuffer indices, int offset,
            int count) {
     ...
     * @param blendOrder draw order number (0 by default). Only the lowest 15 bits are used.
     */
    public void setBlendOrderAt(@EntityInstance int instance, int primitiveIndex,
            int blendOrder) {
        nSetBlendOrderAt(mNativeObject, instance, primitiveIndex, blendOrder);
    }

    public int getBlendOrderAt(@EntityInstance int instance, int primitiveIndex) {
     ...
     * @param enabled true for global, false for local blend ordering.
     */
    public void setGlobalBlendOrderEnabledAt(@EntityInstance int instance, int primitiveIndex,
            boolean enabled) {
        nSetGlobalBlendOrderEnabledAt(mNativeObject, instance, primitiveIndex, enabled);
    }

    public boolean isGlobalBlendOrderEnabledAt(@EntityInstance int instance, int primitiveIndex) {
    ...
    public Set<VertexBuffer.VertexAttribute> getEnabledAttributesAt(
            @EntityInstance int i, int primitiveIndex) {

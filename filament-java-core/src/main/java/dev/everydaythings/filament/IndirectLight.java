...
public class IndirectLight {
    ...
    public static float[] getDirectionEstimate(float[] sh, float[] direction) {
        if (sh.length < 9 * 3) {
            throw new ArrayIndexOutOfBoundsException(
    ...
    public float[] getDirectionEstimate(float[] direction) {
        direction = Asserts.assertFloat3(direction);
    ...
    public static float[] getColorEstimate(float[] colorIntensity, float[] sh, float x, float y, float z) {
        if (sh.length < 9 * 3) {
            throw new ArrayIndexOutOfBoundsException(
                    "3 bands SH required, array must be at least 9 x float3");
        }
    ...
    public float[] getColorEstimate(float[] colorIntensity, float x, float y, float z) {
        colorIntensity = Asserts.assertFloat4(colorIntensity);

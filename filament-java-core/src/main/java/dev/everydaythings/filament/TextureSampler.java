...
public class TextureSampler {
     ...
     */
    public TextureSampler(MagFilter minMag) {
     ...
     */
    public TextureSampler(MagFilter minMag, WrapMode wrap) {
     ...
     * @param wrap {@link WrapMode wrapping mode} for all directions
     */
    public TextureSampler(MinFilter min, MagFilter mag, WrapMode wrap) {
     ...
     */
    public TextureSampler(MinFilter min, MagFilter mag,
            WrapMode s, WrapMode t, WrapMode r) {
     ...
     */
    public TextureSampler(CompareMode mode) {
     ...
     */
    public TextureSampler(CompareMode mode, CompareFunction function) {
    ...
    private static MinFilter minFilterFromMagFilter(MagFilter minMag) {
        switch (minMag) {
            case NEAREST:

...
public class VertexBuffer {
    ...
    public static class Builder {
        ...
        public Builder attribute(VertexAttribute attribute,
                int bufferIndex, AttributeType attributeType,
        ...
        public Builder normalized(VertexAttribute attribute) {
     ...
     */
    public void setBufferAt(Engine engine, int bufferIndex, Buffer buffer,
            int destOffsetInBytes, int count) {
     ...
     */
    public void setBufferObjectAt(Engine engine, int bufferIndex,

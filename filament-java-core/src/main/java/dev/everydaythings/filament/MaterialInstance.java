...
public class MaterialInstance {
    ...
    public static MaterialInstance duplicate(MaterialInstance other, String name) {
     ...
     */
    public void setParameter(String name, boolean x) {
     ...
     */
    public void setParameter(String name, boolean x, boolean y) {
     ...
     */
    public void setParameter(String name, boolean x, boolean y, boolean z) {
     ...
     */
    public void setParameter(String name, boolean x, boolean y, boolean z, boolean w) {
     ...
     */
    public void setParameter(String name, Colors.RgbType type,
     ...
     */
    public void setParameter(String name, Colors.RgbaType type,
     ...
     */
    public void setScissor(int left, int bottom,
     ...
     */
    public void setTransparencyMode(Material.TransparencyMode mode) {
     ...
     * Rasterization: culling</a>
     */
    public void setCullingMode(Material.CullingMode colorPassCullingMode,
                               Material.CullingMode shadowPassCullingMode) {
     ...
     */
    public void setStencilReferenceValue(int value, StencilFace face) {
     ...
     */
    public void setStencilReadMask(int readMask, StencilFace face) {
     ...
     */
    public void setStencilReadMask(int readMask) {
     ...
     * @param face the faces to update the read mask for
     */
    public void setStencilWriteMask(int writeMask, StencilFace face) {
    ...
    private static native void nSetParameterBool2(long nativeMaterialInstance,
            String name, boolean x, boolean y);
    ...
    private static native void nSetParameterBool3(long nativeMaterialInstance,
            String name, boolean x, boolean y, boolean z);

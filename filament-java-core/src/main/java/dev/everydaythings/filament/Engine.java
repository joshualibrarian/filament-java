...
public class Engine {
    ...
    public static Engine create(Object sharedContext) {
        return new Builder()
    ...
    /**
     * Creates a {@link SwapChain} from a raw OS native window pointer.
     *
     * <p>On Linux, this is an X11 {@code Window} handle. On Windows, this is an {@code HWND}.
     * On macOS, this is a {@code CAMetalLayer*} or {@code NSView*}.</p>
     *
     * @param pointer the native window pointer
     * @param flags configuration flags, see {@link SwapChainFlags}
     *
     * @return a newly created {@link SwapChain} object
     *
     * @exception IllegalStateException can be thrown if the SwapChain couldn't be created
     */
    public SwapChain createSwapChainFromRawPointer(long pointer, long flags) {
        long nativeSwapChain =
                nCreateSwapChainFromRawPointer(getNativeObject(), pointer, flags);
        if (nativeSwapChain == 0) throw new IllegalStateException("Couldn't create SwapChain");
        return new SwapChain(nativeSwapChain, null);
    }
     ...
     */
    public boolean isValidRenderer(Renderer object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidView(View object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidScene(Scene object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidFence(Fence object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidStream(Stream object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidIndexBuffer(IndexBuffer object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidVertexBuffer(VertexBuffer object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidSkinningBuffer(SkinningBuffer object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidMorphTargetBuffer(MorphTargetBuffer object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidIndirectLight(IndirectLight object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidMaterial(Material object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidMaterialInstance(Material ma, MaterialInstance mi) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidExpensiveMaterialInstance(MaterialInstance object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidSkybox(Skybox object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidColorGrading(ColorGrading object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidTexture(Texture object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidRenderTarget(RenderTarget object) {
     ...
     * @return returns true if the specified object is valid.
     */
    public boolean isValidSwapChain(SwapChain object) {
     ...
     */
    public void destroyMorphTargetBuffer(MorphTargetBuffer morphTargetBuffer) {

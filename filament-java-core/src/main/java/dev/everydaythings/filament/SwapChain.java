...
public class SwapChain {
     ...
     */
    public static boolean isMSAASwapChainSupported(Engine engine, int samples) {
     ...
     */
    public void setFrameCompletedCallback(Object handler, Runnable callback) {
     ...
     */
    public void setFrameScheduledCallback(Object handler, Runnable callback) {

...
import static dev.everydaythings.filament.Texture.Type.COMPRESSED;
...
public class Texture {
    ...
    public static class PixelBufferDescriptor {
         ...
         */
        public PixelBufferDescriptor(Buffer storage,
         ...
         * @see #setCallback
         */
        public PixelBufferDescriptor(ByteBuffer storage,
         ...
         * @param callback      A callback executed by <code>handler</code> when <code>storage</code> is no longer needed.
         */
        public void setCallback(Object handler, Runnable callback) {
            this.handler = handler;
            this.callback = callback;
        }
         ...
         */
        public static int computeDataSize(Format format, Type type,
                int stride, int height, int alignment) {
     ...
     */
    public static boolean isTextureFormatSupported(Engine engine,
     ...
     * @return <code>true</code> if this format is supported for texturing.
     */
    public static boolean isTextureFormatMipmappable(Engine engine,
            InternalFormat format) {
     ...
     */
    public static boolean validatePixelFormatAndType(InternalFormat internalFormat,
     ...
     */
    public static int getMaxTextureSize(Engine engine, Sampler type) {
    ...
    public static class Builder {
        ...
        public Builder sampler(Sampler target) {
        ...
        public Builder swizzle(Swizzle r, Swizzle g, Swizzle b, Swizzle a) {
     ...
     * @see PixelBufferDescriptor
     */
    public void setImage(Engine engine,
            int level,
     ...
     */
     @Deprecated
    public void setImage(Engine engine, int level,
            PixelBufferDescriptor buffer,
     ...
     * @see Builder#sampler
     */
    public void setExternalImage(Engine engine, long eglImage) {
     ...
     */
    public void setExternalImage(Engine engine, Object externalImageRef) {
     ...
     * outside of <code>buffer</code>.
     */
    public void generatePrefilterMipmap(Engine engine,
        PixelBufferDescriptor buffer, int[] faceOffsetsInBytes,

...
public class LightManager {
    ...
    public static class ShadowCascades {
         ...
         */
        public static void computeUniformSplits(float[] splitPositions,
                int cascades) {
         ...
         */
        public static void computeLogSplits(float[] splitPositions,
                int cascades, float near, float far) {
            if (splitPositions.length < cascades - 1) {
                throw new ArrayIndexOutOfBoundsException(
                        String.format("splitPositions array length must be at least %d", cascades - 1));
            }
         ...
         */
        public static void computePracticalSplits(float[] splitPositions,
              int cascades, float near, float far, float lambda) {
            if (splitPositions.length < cascades - 1) {
                throw new ArrayIndexOutOfBoundsException(
                        String.format("splitPositions array length must be at least %d", cascades - 1));
            }
    ...
    public float[] getPosition(@EntityInstance int i, float[] out) {
    ...
    public float[] getDirection(@EntityInstance int i, float[] out) {
        out = Asserts.assertFloat3(out);
    ...
    public float[] getColor(@EntityInstance int i, float[] out) {
        out = Asserts.assertFloat3(out);

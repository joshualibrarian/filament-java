...
import static dev.everydaythings.filament.Asserts.assertFloat3In;
import static dev.everydaythings.filament.Asserts.assertFloat4In;
...
public class View {
     ...
     */
    void setChannelDepthClearEnabled(int channel, boolean enabled) {
     ...
     */
    boolean isChannelDepthClearEnabled(int channel) {
     ...
     */
    public void setAntiAliasing(AntiAliasing type) {
     ...
     *
     * @deprecated Use {@link #setColorGrading(dev.everydaythings.filament.ColorGrading)}
     */
    @Deprecated
    public void setToneMapping(ToneMapping type) {
    }
    ...
    public float[] getLastDynamicResolutionScale(float[] out) {
     ...
     * @see #setShadowType
     */
    public void setVsmShadowOptions(VsmShadowOptions options) {
     ...
     * @see #setShadowType
     */
    public void setSoftShadowOptions(SoftShadowOptions options) {
    ...
    public void pick(int x, int y,
            Object handler, OnPickCallback callback) {
    ...
    public float[] getMaterialGlobal(int index, float[] out) {

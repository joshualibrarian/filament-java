...
import dev.everydaythings.filament.proguard.UsedByNative;
import dev.everydaythings.filament.Engine.FeatureLevel;
...
public class Material {
    ...
    public static class Parameter {
        ...
        private Parameter(String name, Type type, Precision precision,
                int count) {
            this.name = name;
            this.type = type;
        ...
        @SuppressWarnings("unused")
        @UsedByNative("Material.cpp")
        private static void add(List<Parameter> parameters, String name,
    ...
    public static class Builder {
        ...
        public Builder sphericalHarmonicsBandCount(int shBandCount) {
     ...
     *                      by backend.
     */
    public void compile(CompilerPriorityQueue priority,
                        int variants,
                        Object handler,
                        Runnable callback) {
     ...
     */
    public void setDefaultParameter(String name, boolean x) {
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, float x) {
        mDefaultInstance.setParameter(name, x);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, int x) {
        mDefaultInstance.setParameter(name, x);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, boolean x, boolean y) {
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, float x, float y) {
        mDefaultInstance.setParameter(name, x, y);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, int x, int y) {
        mDefaultInstance.setParameter(name, x, y);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, boolean x, boolean y, boolean z) {
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, float x, float y, float z) {
        mDefaultInstance.setParameter(name, x, y, z);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, int x, int y, int z) {
        mDefaultInstance.setParameter(name, x, y, z);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, boolean x, boolean y, boolean z, boolean w) {
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, float x, float y, float z, float w) {
        mDefaultInstance.setParameter(name, x, y, z, w);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, int x, int y, int z, int w) {
        mDefaultInstance.setParameter(name, x, y, z, w);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name,
            MaterialInstance.BooleanElement type, boolean[] v,
     ...
     */
    public void setDefaultParameter(String name,
            MaterialInstance.IntElement type, int[] v,
            int offset, int count) {
        mDefaultInstance.setParameter(name, type, v, offset, count);
    }
     ...
     */
    public void setDefaultParameter(String name,
            MaterialInstance.FloatElement type, float[] v,
            int offset, int count) {
        mDefaultInstance.setParameter(name, type, v, offset, count);
    }
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, Colors.RgbType type,
     ...
     * @see Material#getDefaultInstance()
     */
    public void setDefaultParameter(String name, Colors.RgbaType type,
    ...
    private static native long nBuilderBuild(long nativeEngine, Buffer buffer, int size, int shBandCount, int shadowQuality, int uboBatchingMode);
    ...
    private static native void nGetParameters(long nativeMaterial,
            List<Parameter> parameters, int count);

...
public class AssetLoader {
     ...
     */
    public AssetLoader(Engine engine, MaterialProvider provider,
    ...
    public FilamentAsset createInstancedAsset(Buffer buffer,
    ...
    @SuppressWarnings("unused")
    public FilamentInstance createInstance(FilamentAsset asset) {

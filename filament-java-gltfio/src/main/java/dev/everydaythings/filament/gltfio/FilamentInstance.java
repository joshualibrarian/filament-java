...
public class FilamentInstance {
     ...
     */
    public void attachSkin(int skinIndex, @Entity int target) {
     ...
     * This is a no-op if the given skin index or target is invalid.
     */
    public void detachSkin(int skinIndex, @Entity int target) {
     ...
     */
    public @Entity int[] getJointsAt(int skinIndex) {

...
package dev.everydaythings.filament.gltfio;


import dev.everydaythings.filament.Box;
import dev.everydaythings.filament.Engine;
import dev.everydaythings.filament.Entity;
...
public class FilamentAsset {
     ...
     */
    public int popRenderables(@Entity int[] entities) {
     ...
     */
    public @Entity int[] getLightEntities() {
     ...
     */
    public @Entity int[] getRenderableEntities() {
     ...
     * </p>
     *
     * @see dev.everydaythings.filament.Camera#setScaling
     */
    public @Entity int[] getCameraEntities() {
     ...
     */
    public @Entity int[] getEntitiesByName(String name) {
     ...
     */
    public @Entity int[] getEntitiesByPrefix(String prefix) {
     ...
     */
    public String[] getMorphTargetNames(@Entity int entity) {

...
Java_dev_everydaythings_filament_IndexBuffer_nCreateBuilder(JNIEnv *env, jclass type) {
    return (jlong) new IndexBuffer::Builder();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndexBuffer_nDestroyBuilder(JNIEnv *env, jclass type,
        jlong nativeBuilder) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndexBuffer_nBuilderIndexCount(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndexBuffer_nBuilderBufferType(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_IndexBuffer_nBuilderBuild(JNIEnv *env, jclass type,
...
Java_dev_everydaythings_filament_IndexBuffer_nGetIndexCount(JNIEnv *env, jclass type,
...
Java_dev_everydaythings_filament_IndexBuffer_nSetBuffer(JNIEnv *env, jclass type,

...
Java_dev_everydaythings_filament_VertexBuffer_nCreateBuilder(JNIEnv*, jclass) {
    return (jlong) new VertexBuffer::Builder();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nDestroyBuilder(JNIEnv*, jclass,
        jlong nativeBuilder) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nBuilderVertexCount(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nBuilderEnableBufferObjects(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nBuilderBufferCount(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nBuilderAttribute(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nBuilderNormalized(JNIEnv*, jclass,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nBuilderBuild(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_VertexBuffer_nGetVertexCount(JNIEnv*, jclass,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nSetBufferAt(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_VertexBuffer_nSetBufferObjectAt(JNIEnv*, jclass,

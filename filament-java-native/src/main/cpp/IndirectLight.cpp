...
Java_dev_everydaythings_filament_IndirectLight_nCreateBuilder(JNIEnv*, jclass) {
    return (jlong) new IndirectLight::Builder();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nDestroyBuilder(JNIEnv*, jclass,
        jlong nativeBuilder) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_IndirectLight_nBuilderBuild(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nBuilderReflections(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nIrradiance(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nRadiance(JNIEnv* env, jclass,
        jlong nativeBuilder, jint bands, jfloatArray sh_) {
    IndirectLight::Builder* builder = (IndirectLight::Builder*) nativeBuilder;
    jfloat* sh = env->GetFloatArrayElements(sh_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nIrradianceAsTexture(JNIEnv*, jclass,
        jlong nativeBuilder, jlong nativeTexture) {
    IndirectLight::Builder* builder = (IndirectLight::Builder*) nativeBuilder;
    const Texture* texture = (const Texture*) nativeTexture;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nIntensity(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nRotation(JNIEnv *, jclass, jlong nativeBuilder,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nSetIntensity(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_IndirectLight_nGetIntensity(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nSetRotation(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nGetRotation(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_IndirectLight_nGetDirectionEstimate(JNIEnv* env, jclass,
...
extern "C" [[deprecated]] JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nGetColorEstimate(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_IndirectLight_nGetReflectionsTexture(JNIEnv* env, jclass,
        jlong nativeIndirectLight) {
    IndirectLight *indirectLight = (IndirectLight *) nativeIndirectLight;
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_IndirectLight_nGetIrradianceTexture(JNIEnv* env, jclass,
        jlong nativeIndirectLight) {
    IndirectLight *indirectLight = (IndirectLight *) nativeIndirectLight;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nGetDirectionEstimateStatic(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_IndirectLight_nGetColorEstimateStatic(JNIEnv *env, jclass,

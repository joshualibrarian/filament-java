...
Java_dev_everydaythings_filament_Renderer_nSkipFrame(JNIEnv *, jclass, jlong nativeRenderer,
...
Java_dev_everydaythings_filament_Renderer_nShouldRenderFrame(JNIEnv *, jclass, jlong nativeRenderer) {
    Renderer *renderer = (Renderer *) nativeRenderer;
    return (jboolean) renderer->shouldRenderFrame();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_Renderer_nBeginFrame(JNIEnv *, jclass, jlong nativeRenderer,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nEndFrame(JNIEnv *, jclass, jlong nativeRenderer) {
    Renderer *renderer = (Renderer *) nativeRenderer;
    renderer->endFrame();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nRender(JNIEnv *, jclass, jlong nativeRenderer,
        jlong nativeView) {
    Renderer *renderer = (Renderer *) nativeRenderer;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nRenderStandaloneView(JNIEnv *, jclass, jlong nativeRenderer,
        jlong nativeView) {
    Renderer *renderer = (Renderer *) nativeRenderer;
    View *view = (View *) nativeView;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nCopyFrame(JNIEnv *, jclass, jlong nativeRenderer,
...
Java_dev_everydaythings_filament_Renderer_nReadPixels(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Renderer_nReadPixelsEx(JNIEnv *env, jclass,
...
Java_dev_everydaythings_filament_Renderer_nGetUserTime(JNIEnv*, jclass, jlong nativeRenderer) {
    Renderer *renderer = (Renderer *) nativeRenderer;
    return renderer->getUserTime();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nResetUserTime(JNIEnv*, jclass, jlong nativeRenderer) {
    Renderer *renderer = (Renderer *) nativeRenderer;
    renderer->resetUserTime();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nSetDisplayInfo(JNIEnv*, jclass, jlong nativeRenderer, jfloat refreshRate) {
    Renderer *renderer = (Renderer *) nativeRenderer;
    renderer->setDisplayInfo({ .refreshRate = refreshRate });
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nSetFrameRateOptions(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nSetClearOptions(JNIEnv *, jclass ,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nSetPresentationTime(JNIEnv *, jclass ,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Renderer_nSetVsyncTime(JNIEnv *, jclass,
...
Java_dev_everydaythings_filament_Renderer_nSkipNextFrames(JNIEnv *, jclass ,
...
Java_dev_everydaythings_filament_Renderer_nGetFrameToSkipCount(JNIEnv *, jclass ,

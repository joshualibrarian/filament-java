...
Java_dev_everydaythings_filament_Material_nBuilderBuild(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_Material_nGetDefaultInstance(JNIEnv*, jclass,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_Material_nCreateInstance(JNIEnv*, jclass,
        jlong nativeMaterial) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_Material_nCreateInstanceWithName(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_Material_nGetName(JNIEnv* env, jclass, jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
Java_dev_everydaythings_filament_Material_nGetShading(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetInterpolation(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetBlendingMode(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetTransparencyMode(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetRefractionMode(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetRefractionType(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetReflectionMode(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetFeatureLevel(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetVertexDomain(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetCullingMode(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
Java_dev_everydaythings_filament_Material_nIsColorWriteEnabled(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_Material_nIsDepthWriteEnabled(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_Material_nIsDepthCullingEnabled(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_Material_nIsDoubleSided(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_Material_nIsAlphaToCoverageEnabled(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
Java_dev_everydaythings_filament_Material_nGetMaskThreshold(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jfloat JNICALL
Java_dev_everydaythings_filament_Material_nGetSpecularAntiAliasingVariance(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jfloat JNICALL
Java_dev_everydaythings_filament_Material_nGetSpecularAntiAliasingThreshold(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetParameterCount(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
Java_dev_everydaythings_filament_Material_nGetParameters(JNIEnv* env, jclass,
    ...
    jclass parameterClass = env->FindClass("dev/everydaythings/filament/Material$Parameter");
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_Material_nGetRequiredAttributes(JNIEnv*, jclass,
        jlong nativeMaterial) {
    Material* material = (Material*) nativeMaterial;
...
Java_dev_everydaythings_filament_Material_nHasParameter(JNIEnv* env, jclass,
        jlong nativeMaterial, jstring name_) {
    Material* material = (Material*) nativeMaterial;
    const char* name = env->GetStringUTFChars(name_, 0);
...
Java_dev_everydaythings_filament_Material_nGetParameterTransformName(JNIEnv* env, jclass,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Material_nCompile(JNIEnv *env, jclass clazz,

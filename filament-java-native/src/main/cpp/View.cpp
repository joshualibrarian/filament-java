...
Java_dev_everydaythings_filament_View_nSetName(JNIEnv* env, jclass, jlong nativeView, jstring name_) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetScene(JNIEnv*, jclass, jlong nativeView, jlong nativeScene) {
    View* view = (View*) nativeView;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetCamera(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_View_nHasCamera(JNIEnv*, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
    return (jboolean)view->hasCamera();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetColorGrading(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetViewport(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetVisibleLayers(JNIEnv*, jclass, jlong nativeView, jint select, jint value) {
    View* view = (View*) nativeView;
    view->setVisibleLayers((uint8_t) select, (uint8_t) value);
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_View_nGetVisibleLayers(JNIEnv*, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
    return view->getVisibleLayers();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetShadowingEnabled(JNIEnv*, jclass, jlong nativeView, jboolean enabled) {
    View* view = (View*) nativeView;
    view->setShadowingEnabled(enabled);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetRenderTarget(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetSampleCount(JNIEnv*, jclass, jlong nativeView, jint count) {
    View* view = (View*) nativeView;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_View_nGetSampleCount(JNIEnv*, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetAntiAliasing(JNIEnv*, jclass, jlong nativeView, jint type) {
    View* view = (View*) nativeView;
    view->setAntiAliasing(View::AntiAliasing(type));
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_View_nGetAntiAliasing(JNIEnv*, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
    return (jint) view->getAntiAliasing();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetDithering(JNIEnv*, jclass, jlong nativeView, jint dithering) {
    View* view = (View*) nativeView;
    view->setDithering((View::Dithering) dithering);
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_View_nGetDithering(JNIEnv*, jclass,
        jlong nativeView) {
    View* view = (View*) nativeView;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetDynamicResolutionOptions(JNIEnv*, jclass, jlong nativeView,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nGetLastDynamicResolutionScale(JNIEnv *env, jclass, jlong nativeView, jfloatArray out_) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetShadowType(JNIEnv*, jclass, jlong nativeView, jint type) {
    View* view = (View*) nativeView;
    view->setShadowType((View::ShadowType) type);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetVsmShadowOptions(JNIEnv*, jclass, jlong nativeView,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetSoftShadowOptions(JNIEnv*, jclass, jlong nativeView,
...
Java_dev_everydaythings_filament_View_nSetRenderQuality(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetDynamicLightingOptions(JNIEnv*,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetPostProcessingEnabled(JNIEnv*,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_View_nIsPostProcessingEnabled(JNIEnv*,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetFrontFaceWindingInverted(JNIEnv*,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_View_nIsFrontFaceWindingInverted(JNIEnv*,
        jclass, jlong nativeView) {
    View* view = (View*) nativeView;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetTransparentPickingEnabled(JNIEnv*,
        jclass, jlong nativeView, jboolean enabled) {
    View* view = (View*) nativeView;
...
extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_View_nIsTransparentPickingEnabled(JNIEnv*,
        jclass, jlong nativeView) {
    View* view = (View*) nativeView;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetAmbientOcclusion(JNIEnv*, jclass, jlong nativeView, jint ordinal) {
    View* view = (View*) nativeView;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_View_nGetAmbientOcclusion(JNIEnv*, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetAmbientOcclusionOptions(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetSSCTOptions(JNIEnv *, jclass, jlong nativeView,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetBloomOptions(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetFogOptions(JNIEnv *, jclass , jlong nativeView,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetBlendMode(JNIEnv *, jclass , jlong nativeView, jint blendMode) {
    View* view = (View*) nativeView;
    view->setBlendMode((View::BlendMode)blendMode);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetDepthOfFieldOptions(JNIEnv *, jclass,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetVignetteOptions(JNIEnv*, jclass, jlong nativeView, jfloat midPoint, jfloat roundness,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetMultiSampleAntiAliasingOptions(JNIEnv* env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetTemporalAntiAliasingOptions(JNIEnv *, jclass,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetScreenSpaceReflectionsOptions(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_View_nIsShadowingEnabled(JNIEnv *, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
    return (jboolean)view->isShadowingEnabled();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetFrustumCullingEnabled(JNIEnv*, jclass, jlong nativeView, jboolean enabled) {
    View* view = (View*) nativeView;
    view->setFrustumCullingEnabled(enabled);
}

extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_View_nIsFrustumCullingEnabled(JNIEnv*, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetScreenSpaceRefractionEnabled(JNIEnv *, jclass,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_View_nIsScreenSpaceRefractionEnabled(JNIEnv *, jclass,
        jlong nativeView) {
    View* view = (View*) nativeView;
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nPick(JNIEnv* env, jclass,
        jlong nativeView,
    ...
    static const struct JniState {
        ...
        explicit JniState(JNIEnv* env) noexcept {
            internalOnPickCallbackClass = env->FindClass("dev/everydaythings/filament/View$InternalOnPickCallback");
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetStencilBufferEnabled(JNIEnv *, jclass, jlong nativeView,
        jboolean enabled) {
    View* view = (View*) nativeView;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_View_nIsStencilBufferEnabled(JNIEnv *, jclass, jlong nativeView) {
    View* view = (View*) nativeView;
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetStereoscopicOptions(JNIEnv *, jclass, jlong nativeView,
        jboolean enabled) {
    View* view = (View*) nativeView;
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetGuardBandOptions(JNIEnv *, jclass,
        jlong nativeView, jboolean enabled) {
    View* view = (View*) nativeView;
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetMaterialGlobal(JNIEnv * , jclass, jlong nativeView,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nGetMaterialGlobal(JNIEnv *env, jclass clazz,
...
Java_dev_everydaythings_filament_View_nGetFogEntity(JNIEnv *env, jclass clazz,
        jlong nativeView) {
    View *view = (View *) nativeView;
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nClearFrameHistory(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_View_nSetChannelDepthClearEnabled(JNIEnv *, jclass ,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_View_nIsChannelDepthClearEnabled(JNIEnv *env, jclass clazz,

...
Java_dev_everydaythings_filament_BufferObject_nCreateBuilder(JNIEnv *env, jclass type) {
    return (jlong) new BufferObject::Builder();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_BufferObject_nDestroyBuilder(JNIEnv *env, jclass type,
        jlong nativeBuilder) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_BufferObject_nBuilderSize(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_BufferObject_nBuilderBindingType(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_BufferObject_nBuilderBuild(JNIEnv *env, jclass type,
...
Java_dev_everydaythings_filament_BufferObject_nGetByteCount(JNIEnv *env, jclass type,
...
Java_dev_everydaythings_filament_BufferObject_nSetBuffer(JNIEnv *env, jclass type,

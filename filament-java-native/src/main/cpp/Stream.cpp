...
Java_dev_everydaythings_filament_Stream_nCreateBuilder(JNIEnv*, jclass) {
    return (jlong) new StreamBuilder{};
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Stream_nDestroyBuilder(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Stream_nBuilderStreamSource(JNIEnv* env,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Stream_nBuilderWidth(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Stream_nBuilderHeight(JNIEnv*, jclass,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_Stream_nBuilderBuild(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_Stream_nGetStreamType(JNIEnv*, jclass, jlong nativeStream) {
    Stream* stream = (Stream*) nativeStream;
    return (jint) stream->getStreamType();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Stream_nSetDimensions(JNIEnv*, jclass, jlong nativeStream,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_Stream_nGetTimestamp(JNIEnv*, jclass, jlong nativeStream) {
    Stream *stream = (Stream *) nativeStream;
    return stream->getTimestamp();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Stream_nSetAcquiredImage(JNIEnv* env, jclass, jlong nativeStream,

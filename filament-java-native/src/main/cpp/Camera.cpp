...
Java_dev_everydaythings_filament_Camera_nSetProjection(JNIEnv*, jclass, jlong nativeCamera,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetProjectionFov(JNIEnv*, jclass ,
...
Java_dev_everydaythings_filament_Camera_nGetFieldOfViewInDegrees(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetLensProjection(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetCustomProjection(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetCustomEyeProjection(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetScaling(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetShift(JNIEnv* env, jclass,
        jlong nativeCamera, jdouble x, jdouble y) {
    Camera *camera = (Camera *) nativeCamera;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetShift(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nLookAt(JNIEnv*, jclass, jlong nativeCamera,
...
extern "C" JNIEXPORT jdouble JNICALL
Java_dev_everydaythings_filament_Camera_nGetNear(JNIEnv*, jclass, jlong nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
    return camera->getNear();
}

extern "C" JNIEXPORT jdouble JNICALL
Java_dev_everydaythings_filament_Camera_nGetCullingFar(JNIEnv*, jclass,
        jlong nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetModelMatrix(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetModelMatrixFp64(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetEyeModelMatrix(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetProjectionMatrix(JNIEnv *env, jclass,
        jlong nativeCamera, jdoubleArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jdouble *out = env->GetDoubleArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetCullingProjectionMatrix(JNIEnv *env, jclass,
        jlong nativeCamera, jdoubleArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jdouble *out = env->GetDoubleArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetScaling(JNIEnv *env, jclass,
        jlong nativeCamera, jdoubleArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jdouble *out = env->GetDoubleArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetModelMatrix(JNIEnv *env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetModelMatrixFp64(JNIEnv *env, jclass,
        jlong nativeCamera, jdoubleArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jdouble *out = env->GetDoubleArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetViewMatrix(JNIEnv *env, jclass, jlong nativeCamera,
        jfloatArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jfloat *out = env->GetFloatArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetViewMatrixFp64(JNIEnv *env, jclass, jlong nativeCamera,
        jdoubleArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jdouble *out = env->GetDoubleArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetPosition(JNIEnv *env, jclass, jlong nativeCamera,
        jfloatArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jfloat *out = env->GetFloatArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetLeftVector(JNIEnv *env, jclass, jlong nativeCamera,
        jfloatArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jfloat *out = env->GetFloatArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetUpVector(JNIEnv *env, jclass, jlong nativeCamera,
        jfloatArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jfloat *out = env->GetFloatArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nGetForwardVector(JNIEnv *env, jclass,
        jlong nativeCamera, jfloatArray out_) {
    Camera *camera = (Camera *) nativeCamera;
    jfloat *out = env->GetFloatArrayElements(out_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetExposure(JNIEnv*, jclass , jlong nativeCamera,
...
Java_dev_everydaythings_filament_Camera_nGetAperture(JNIEnv*, jclass, jlong nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
    return camera->getAperture();
}

extern "C" JNIEXPORT jfloat JNICALL
Java_dev_everydaythings_filament_Camera_nGetShutterSpeed(JNIEnv*, jclass,
        jlong nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
...
extern "C" JNIEXPORT jfloat JNICALL
Java_dev_everydaythings_filament_Camera_nGetSensitivity(JNIEnv*, jclass,
        jlong nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_Camera_nSetFocusDistance(JNIEnv*, jclass,
...
extern "C" JNIEXPORT jfloat JNICALL
Java_dev_everydaythings_filament_Camera_nGetFocusDistance(JNIEnv*, jclass,
        jlong nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
...
extern "C" JNIEXPORT jdouble JNICALL
Java_dev_everydaythings_filament_Camera_nGetFocalLength(JNIEnv*, jclass,
        jlong nativeCamera) {
    Camera *camera = (Camera *) nativeCamera;
...
extern "C" JNIEXPORT jdouble JNICALL
Java_dev_everydaythings_filament_Camera_nComputeEffectiveFocalLength(JNIEnv*, jclass,
        jdouble focalLength, jdouble focusDistance) {
    return Camera::computeEffectiveFocalLength(focalLength, focusDistance);
}

extern "C" JNIEXPORT jdouble JNICALL
Java_dev_everydaythings_filament_Camera_nComputeEffectiveFov(JNIEnv*, jclass,

...
Java_dev_everydaythings_filament_ColorGrading_nCreateBuilder(JNIEnv*, jclass) {
    return (jlong) new ColorGrading::Builder();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nDestroyBuilder(JNIEnv*, jclass, jlong nativeBuilder) {
    ColorGrading::Builder* builder = (ColorGrading::Builder*) nativeBuilder;
    delete builder;
}

extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderBuild(JNIEnv*, jclass, jlong nativeBuilder, jlong nativeEngine) {
    ColorGrading::Builder* builder = (ColorGrading::Builder*) nativeBuilder;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderQuality(JNIEnv*, jclass, jlong nativeBuilder, jint quality_) {
    ColorGrading::Builder* builder = (ColorGrading::Builder*) nativeBuilder;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderFormat(JNIEnv*, jclass, jlong nativeBuilder, jint format_) {
    ColorGrading::Builder* builder = (ColorGrading::Builder*) nativeBuilder;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderDimensions(JNIEnv*, jclass, jlong nativeBuilder, jint dim_) {
    ColorGrading::Builder* builder = (ColorGrading::Builder*) nativeBuilder;
    builder->dimensions((uint8_t)dim_);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderToneMapper(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderToneMapping(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderLuminanceScaling(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderGamutMapping(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderExposure(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderNightAdaptation(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderWhiteBalance(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderChannelMixer(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_ColorGrading_nBuilderShadowsMidtonesHighlights(JNIEnv* env, jclass, jlong nativeBuilder,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderSlopeOffsetPower(JNIEnv* env, jclass,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderContrast(JNIEnv*, jclass,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderVibrance(JNIEnv*, jclass,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderSaturation(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_ColorGrading_nBuilderCurves(JNIEnv* env, jclass,

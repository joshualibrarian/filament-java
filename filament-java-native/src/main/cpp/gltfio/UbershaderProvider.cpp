...
Java_dev_everydaythings_filament_gltfio_UbershaderProvider_nCreateUbershaderProvider(JNIEnv*, jclass,
        jlong nativeEngine) {
...
Java_dev_everydaythings_filament_gltfio_UbershaderProvider_nDestroyUbershaderProvider(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_UbershaderProvider_nDestroyMaterials(JNIEnv*, jclass,
        jlong nativeProvider) {
    auto provider = (MaterialProvider*) nativeProvider;
...
Java_dev_everydaythings_filament_gltfio_UbershaderProvider_nCreateMaterialInstance(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT long JNICALL
Java_dev_everydaythings_filament_gltfio_UbershaderProvider_nGetMaterial(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_gltfio_UbershaderProvider_nGetMaterialCount(JNIEnv*, jclass,
        jlong nativeProvider) {
    auto provider = (MaterialProvider*) nativeProvider;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_UbershaderProvider_nGetMaterials(JNIEnv* env, jclass,

...
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetRoot(JNIEnv*, jclass, jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
    return asset->getRoot().getId();
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nPopRenderable(JNIEnv*, jclass,
        jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nPopRenderables(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetEntityCount(JNIEnv*, jclass,
        jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetEntities(JNIEnv* env, jclass,
        jlong nativeAsset, jintArray result) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
    jsize available = env->GetArrayLength(result);
    Entity* entities = (Entity*) env->GetIntArrayElements(result, nullptr);
...
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetFirstEntityByName(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jint
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetEntitiesByName(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jint
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetEntitiesByPrefix(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetLightEntityCount(JNIEnv*, jclass,
        jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetLightEntities(JNIEnv* env, jclass,
        jlong nativeAsset, jintArray result) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetRenderableEntityCount(JNIEnv*, jclass,
        jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetRenderableEntities(JNIEnv* env, jclass,
        jlong nativeAsset, jintArray result) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
    const jsize available = env->GetArrayLength(result);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetCameraEntities(JNIEnv* env, jclass,
        jlong nativeAsset, jintArray result) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
    const jsize available = env->GetArrayLength(result);
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetCameraEntityCount(JNIEnv*, jclass,
        jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetBoundingBox(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetName(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jstring JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetExtras(JNIEnv* env, jclass,
        jlong nativeAsset, jint entityId) {
    Entity entity = Entity::import(entityId);
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetInstance(JNIEnv* , jclass,
        jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetResourceUriCount(JNIEnv*, jclass,
                                                                           jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetResourceUris(JNIEnv* env, jclass,
                                                                       jlong nativeAsset,
                                                                       jobjectArray result) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetMorphTargetCount(JNIEnv*, jclass,
        jlong nativeAsset, jint entityId) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;
    Entity entity = Entity::import(entityId);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nGetMorphTargetNames(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_FilamentAsset_nReleaseSourceData(JNIEnv* env, jclass,
        jlong nativeAsset) {
    FilamentAsset* asset = (FilamentAsset*) nativeAsset;

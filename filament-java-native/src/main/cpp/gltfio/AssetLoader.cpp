...
public:
    JavaMaterialProvider(JNIEnv* env, jobject provider) : mEnv(env),
        ...
        jclass materialInstanceClass = env->FindClass("dev/everydaythings/filament/MaterialInstance");
        ...
        jclass materialClass = env->FindClass("dev/everydaythings/filament/Material");
        ...
        mCreateMaterialInstance = env->GetMethodID(providerClass, "createMaterialInstance",
                "(L" JAVA_MATERIAL_KEY ";[ILjava/lang/String;Ljava/lang/String;)Ldev/everydaythings/filament/MaterialInstance;");
        assert_invariant(mCreateMaterialInstance);

        mGetMaterial = env->GetMethodID(providerClass, "getMaterial",
                "(L" JAVA_MATERIAL_KEY ";[ILjava/lang/String;)Ldev/everydaythings/filament/Material;");
        assert_invariant(mGetMaterial);

        mGetMaterials = env->GetMethodID(providerClass, "getMaterials",
                "()[Ldev/everydaythings/filament/Material;");
...
Java_dev_everydaythings_filament_gltfio_AssetLoader_nCreateAssetLoader(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_gltfio_AssetLoader_nDestroyAssetLoader(JNIEnv*, jclass,
        jlong nativeLoader) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_gltfio_AssetLoader_nCreateAsset(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_gltfio_AssetLoader_nCreateInstancedAsset(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_gltfio_AssetLoader_nCreateInstance(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_AssetLoader_nEnableDiagnostics(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_AssetLoader_nDestroyAsset(JNIEnv*, jclass,
        jlong nativeLoader, jlong nativeAsset) {
    AssetLoader* loader = (AssetLoader*) nativeLoader;

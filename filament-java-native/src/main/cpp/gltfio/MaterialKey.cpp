...
Java_dev_everydaythings_filament_gltfio_MaterialProvider_00024MaterialKey_nGlobalInit(JNIEnv* env, jclass) {
    MaterialKeyHelper::get().init(env);
}

extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_gltfio_MaterialProvider_00024MaterialKey_nConstrainMaterial(JNIEnv* env, jclass,

...
Java_dev_everydaythings_filament_RenderTarget_nCreateBuilder(JNIEnv *env, jclass type) {
    return (jlong) new RenderTarget::Builder();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_RenderTarget_nDestroyBuilder(JNIEnv *env, jclass type,
        jlong nativeBuilder) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_RenderTarget_nBuilderTexture(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_RenderTarget_nBuilderMipLevel(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_RenderTarget_nBuilderFace(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_RenderTarget_nBuilderLayer(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_RenderTarget_nBuilderBuild(JNIEnv *env, jclass type,
...
Java_dev_everydaythings_filament_RenderTarget_nGetMipLevel(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_RenderTarget_nGetFace(JNIEnv *env, jclass type,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_RenderTarget_nGetLayer(JNIEnv *env, jclass type,
        long nativeTarget, int attachment) {
    RenderTarget* target = (RenderTarget*) nativeTarget;

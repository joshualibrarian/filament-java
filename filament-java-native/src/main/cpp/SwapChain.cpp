...
Java_dev_everydaythings_filament_SwapChain_nSetFrameCompletedCallback(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_SwapChain_nIsSRGBSwapChainSupported(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_SwapChain_nIsMSAASwapChainSupported(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_SwapChain_nIsProtectedContentSupported(
        JNIEnv *, jclass, jlong nativeEngine) {
    Engine* engine = (Engine*) nativeEngine;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_SwapChain_nSetFrameScheduledCallback(JNIEnv* env, jclass,
        jlong nativeSwapChain, jobject handler, jobject runnable) {
    SwapChain* swapChain = (SwapChain*) nativeSwapChain;
    auto* callback = JniCallback::make(env, handler, runnable);
...
extern "C" JNIEXPORT jboolean JNICALL
Java_dev_everydaythings_filament_SwapChain_nIsFrameScheduledCallbackSet(

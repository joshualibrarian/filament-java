...
Java_dev_everydaythings_filament_SkinningBuffer_nCreateBuilder(JNIEnv*, jclass) {
    return (jlong) new SkinningBuffer::Builder();
}

extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_SkinningBuffer_nDestroyBuilder(JNIEnv*, jclass,
        jlong nativeBuilder) {
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_SkinningBuffer_nBuilderBoneCount(JNIEnv*, jclass,
...
extern "C"
JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_SkinningBuffer_nBuilderInitialize(JNIEnv*, jclass,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_dev_everydaythings_filament_SkinningBuffer_nBuilderBuild(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_SkinningBuffer_nSetBonesAsMatrices(JNIEnv* env, jclass,
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_SkinningBuffer_nSetBonesAsQuaternions(JNIEnv* env, jclass,
...
extern "C"
JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_SkinningBuffer_nGetBoneCount(JNIEnv*, jclass,

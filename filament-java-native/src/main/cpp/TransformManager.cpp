...
Java_dev_everydaythings_filament_TransformManager_nHasComponent(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_TransformManager_nGetInstance(JNIEnv*, jclass,
        jlong nativeTransformManager, jint entity_) {
    TransformManager* tm = (TransformManager*) nativeTransformManager;
    Entity& entity = *reinterpret_cast<Entity*>(&entity_);
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_TransformManager_nCreate(JNIEnv*, jclass,
        jlong nativeTransformManager, jint entity_) {
    TransformManager* tm = (TransformManager*) nativeTransformManager;
    Entity& entity = *reinterpret_cast<Entity*>(&entity_);
    tm->create(entity);
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_TransformManager_nCreateArray(JNIEnv* env,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_TransformManager_nCreateArrayFp64(JNIEnv* env,
        jclass, jlong nativeTransformManager, jint entity_, jint parent,
...
Java_dev_everydaythings_filament_TransformManager_nDestroy(JNIEnv*, jclass,
        jlong nativeTransformManager, jint entity_) {
    TransformManager* tm = (TransformManager*) nativeTransformManager;
    Entity& entity = *reinterpret_cast<Entity*>(&entity_);
    tm->destroy(entity);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nSetParent(JNIEnv*, jclass,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_TransformManager_nGetParent(JNIEnv*, jclass,
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_everydaythings_filament_TransformManager_nGetChildCount(JNIEnv*, jclass,
        jlong nativeTransformManager, jint i) {
    TransformManager* tm = (TransformManager*) nativeTransformManager;
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nGetChildren(JNIEnv* env,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nSetTransform(JNIEnv* env,
        jclass, jlong nativeTransformManager, jint i,
        jfloatArray localTransform_) {
    TransformManager* tm = (TransformManager*) nativeTransformManager;
    jfloat *localTransform = env->GetFloatArrayElements(localTransform_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nSetTransformFp64(JNIEnv* env,
        jclass, jlong nativeTransformManager, jint i,
        jdoubleArray localTransform_) {
    TransformManager* tm = (TransformManager*) nativeTransformManager;
    jdouble *localTransform = env->GetDoubleArrayElements(localTransform_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nGetTransform(JNIEnv* env,
        jclass, jlong nativeTransformManager, jint i,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nGetTransformFp64(JNIEnv* env,
        jclass, jlong nativeTransformManager, jint i,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nGetWorldTransform(JNIEnv* env,
        jclass, jlong nativeTransformManager, jint i,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nGetWorldTransformFp64(JNIEnv* env,
        jclass, jlong nativeTransformManager, jint i,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nOpenLocalTransformTransaction(
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_TransformManager_nCommitLocalTransformTransaction(
        JNIEnv*, jclass, jlong nativeTransformManager) {
    TransformManager* tm = (TransformManager*) nativeTransformManager;
...
Java_dev_everydaythings_filament_TransformManager_nSetAccurateTranslationsEnabled(JNIEnv*,
...
Java_dev_everydaythings_filament_TransformManager_nIsAccurateTranslationsEnabled(JNIEnv*,

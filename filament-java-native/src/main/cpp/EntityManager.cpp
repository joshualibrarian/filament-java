...
Java_dev_everydaythings_filament_EntityManager_nGetEntityManager(JNIEnv*, jclass) {
    return (jlong) &EntityManager::get();
}

extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_EntityManager_nCreateArray(JNIEnv* env, jclass,
...
Java_dev_everydaythings_filament_EntityManager_nCreate(JNIEnv*, jclass,
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_EntityManager_nDestroyArray(JNIEnv* env, jclass,
        jlong nativeEntityManager, jint n, jintArray entities_) {
    EntityManager* em = (EntityManager *) nativeEntityManager;
    jint* entities = env->GetIntArrayElements(entities_, NULL);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_everydaythings_filament_EntityManager_nDestroy(JNIEnv*, jclass,
...
Java_dev_everydaythings_filament_EntityManager_nIsAlive(JNIEnv*, jclass,
        jlong nativeEntityManager, jint entity_) {
    EntityManager *em = (EntityManager *) nativeEntityManager;
    Entity& entity = *reinterpret_cast<Entity*>(&entity_);
